    ...
    <Layout modelRight={{ children: <ModalContact />, propsModal: { textBtn: 'Contact' } }}>
      ...
      <HeaderFull className="dsn-container" heroContent={headerData} overlay={5} fullWidth>
        <p className="mt-20 max-w570">
          Miena sipu del inora aid consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis
          nutka , pulvinar dapibus leo della pierrano set amuse.
        </p>
        ...
        <DsnGrid col={2}>
          ...
          <div className="box-right">
            <p className="max-w570 dsn-up mb-15 ">
              ...
              marketing needs and developing the necessary skills for business ownership.
            </p>

            <p className="max-w570 dsn-up">
              but deploy to production. C-suite. First-order optimal strategies build on a culture of
      ...
      <DsnGrid
        ...
        <div className="box-info box-padding background-section">
          ...
          <p className="max-w570 dsn-up mb-10 ">
            When our team provides design and digital marketing. Applied arts can include industrial design,
            graphic design,
          </p>

          <p className="max-w570 dsn-up">
            {' '}
            fashion design, and the decorative arts which traditionally includes craft objects.
          </p>
        ...
        <div className="box-info box-padding background-section order-md-2">
          ...
          <Accordion className={'pb-30 border-bottom'}>
            <AccordionItem title="Website & Mobile App Design" active number={1}>
              <p>
                We’ve created a full-stack structure for our working workflow processes, were from the funny
                the century initial all the made, have spare to negatives.
              </p>
            </AccordionItem>
        ...
        <div className="container">
          <DsnGrid col={2} colTablet={1}>
            ...
            <div className="box-information">
              ...
              <p className="mb-30">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed obcaecati autem distinctio
                veritatis excepturi, fugit iste repellendus, porro delectus rem ducimus cum fugiat, magnam
      ...
      <section className="container section-margin" data-dsn-title="our clients">
        <TitleSection className={`align-items-center text-center`} description={'Our clients'}>
