    ...
    <Layout modelRight={{ children: <ModalContact />, propsModal: { textBtn: 'Contact' } }}>
      ...
      <DsnGrid
        ...
        <div className="box-left">
          ...
          <h4 className="mt-25">
            The good writers touch life often. The mediocre ones run a quick hand over her. The bad ones rape
        ...
        <DsnGrid className="container" col={2} colTablet={1}>
          ...
          <div className="p-relative box-right">
            ...
            <List className="border-top  pt-30 mb-30" col={2} iconSize={'15px'}>
              <List.item
                icon={<FontAwesomeIcon icon={faCheckCircle} className="theme-color" />}
                headingTag="span">
                {' '}
        ...
        <div className="container">
          ...
          <DsnGrid className="background-main" col={2} colTablet={1} rowGapTablet={0} rowGapMobile={0}>
            <div className="p-relative box-padding box-left order-md-2">
              ...
              <h4 className="mb-50">
                Get Dsn Grid today and start building next-generation websites in minutes!
              </h4>
              <ServiceGrid
