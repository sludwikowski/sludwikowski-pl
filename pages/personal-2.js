...
function Personal() {
  ...
  return (
    <Layout modelRight={{ children: <ModalContact />, propsModal: { textBtn: 'Contact' } }}>
      ...
      <HeaderFull className="dsn-container" fullWidth heroContent={headerContent} overlay={6}>
        <p className="mt-30 pb-30 border-bottom max-w570">
          Fusce tempor magna mi, non egestas velit ultricies nec. Aenean convallis, risus non condimentum
      ...
      <section className="section-padding  background-section" data-dsn-title="Resume">
        <div className="container">
          <TitleSection description="My Resume">Education & Experience</TitleSection>
          <DsnGrid col={2}>
            <Resume title="Education">
              <Resume.item title="University of Studies">
                <p className="max-w570">
                  Duis posuere, quam non imperdiet egestas, eros enim mattis mauris, in posuere lacus arcu
                  quis felis. Etiam interdum erat non enim venenatis fermentum.
                </p>
              </Resume.item>

              <Resume.item title="Doctoral Degree">
                <p className="max-w570">
                  Aliquam tincidunt malesuada tortor vitae iaculis. In eu turpis iaculis, feugiat risus quis,
                  aliquet urna. Quisque fringilla mollis risus, eu pulvinar dolor.
                </p>
              </Resume.item>

              <Resume.item title="University of Studies">
                <p className="max-w570">
                  Maecenas finibus nec sem ut imperdiet. Ut tincidunt est ac dolor aliquam sodales. Phasellus
                  sed mauris hendrerit, laoreet sem in, lobortis ante.
                </p>
              </Resume.item>
            </Resume>
            ...
            <Resume title="Education">
              <Resume.item title="University of Studies">
                ...
                <p className="max-w570 mt-10">
                  Praesent dignissim sollicitudin justo, sed elementum quam lacinia quis. Phasellus eleifend
                  tristique posuere. Sed vitae dui nec magna.
                </p>
              </Resume.item>
              ...
              <Resume.item title="Doctoral Degree">
                ...
                <p className="max-w570 mt-10">
                  Maecenas tempus faucibus rutrum. Duis eu aliquam urna. Proin vitae nulla tristique, ornare
                  felis id, congue libero. Nam volutpat euismod quam.
                </p>
              </Resume.item>
          ...
          <div className="text-left flex-column align-items-center w-100">
            <div className="flex-column align-items-center mb-30">
              <div className="section-title mb-20 ">
                <p className="sub-heading  line-bg-left mb-15">My specialization</p>
                <h4 className="text-left title-cap">I am a trending designer who cares about the details</h4>
              </div>
            </div>
            <h5 className="sm-title-block theme-color">Proin laoreet elementum ligula</h5>

            <div className="border-bottom mt-30 mb-30" />

            <p className="max-w570 dsn-text">
              <span className="mb-20">
                I will help you build your brand and grow your business. I create clarifying strategy,
                beautiful logo and identity design.{' '}
              </span>
              <span>
                Donec massa velit, varius a accumsan ac, tempor iaculis massa. Sed placerat justo sed libero
                varius vulputate. Ut a mi tempus massama lesuada fermentum.
              </span>
            </p>
      ...
      <div className="section-margin" data-dsn-title="Our Portfolio">
        <TitleSection className={`container align-items-center text-center`} description={'Our Works'}>
        ...
        <PortfolioSwiper
          ...
          <SwiperPagination className={`justify-content-between dsn-container mb-30`} />
        </PortfolioSwiper>
      </div>
      {/*End Portfolio*/}
      ...
      <div className="section-margin" data-dsn-title="Lasts post">
        <TitleSection className={`container  align-items-center text-center`} description={'Lasts post'}>
