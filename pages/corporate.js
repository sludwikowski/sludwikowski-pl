  ...
  return (
    <Layout modelRight={{ children: <ModalContact />, propsModal: { textBtn: 'Contact' } }}>
      ...
      <div className="p-relative" data-dsn-title="About">
        <BoxRight
          ...
          <p className="mb-15">
            ...
            demoralized by & charms of pleasure of the moment so blinded.
          </p>
      ...
      <div className="container section-margin" data-dsn-title="our Services">
        <TitleSection description={'Our Services'}>Branding Agency</TitleSection>
      ...
      <div className="container section-margin" data-dsn-title="our Blog">
        <TitleSection description={'Lasts post'}>Latest And Greatest Post</TitleSection>
        <BlogSwiper
