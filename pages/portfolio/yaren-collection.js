  ...
  return (
    <Layout>
        ...
        <DsnGrid customGrid={{ desktop: '40% 60%' }}>
          ...
          <div className="intro-project-right">
            ...
            <p className="intro-project-description">
              Vin tries to reflect Diesel’s vision and combines the universe of the rock of the 80’s with a
              clear and essential design to be more confident with its customers who need strong symbols
              through which express themselves
            </p>
      ...
      <BoxGallery className="section-margin container" col={2}>
        <BoxGalleryItem src="/img/project/project2/3.jpg" groupPopup="gallery" />
        <BoxGalleryItem src="/img/project/project2/4.jpg" groupPopup="gallery" />
      </BoxGallery>
      {/*End Gallery List*/}
      ...
      <BoxGallery className="section-margin container" col={3}>
        <BoxGalleryItem src="/img/project/project2/6.jpg" groupPopup="gallery" />
        <BoxGalleryItem src="/img/project/project2/7.jpg" groupPopup="gallery" />

        <BoxGalleryItem src="/img/project/project2/8.jpg" groupPopup="gallery" />
      </BoxGallery>
      {/*End Gallery List*/}
      ...
      <section className="container section-margin">
        <DsnGrid col={2}>
          ...
          <div>
            <p className="dsn-up">
              We learned that different house have different preferences. So we decide that CareDot with
              different color to match different interior isn’t enough. We also make the alarm button
              customisable. This allow user to choose a symbol that make the most sense for their use case
              scenario along with personal message surrounding it.
            </p>
          </div>
        </DsnGrid>
      </section>
