...
function Project3(params) {
  ...
  return (
    <Layout>
        ...
        <DsnGrid customGrid={{ desktop: '40% 60%' }}>
          ...
          <div className="intro-project-right">
            ...
            <p className="intro-project-description">
              Huggl is an induction charging, portable power pack that uses alternative materials to stimulate
              new product experiences and higher social interactions.
            </p>
      ...
      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project3/2.jpg'} overlay={3} caption="asdsadsa" />
      {/*End Parallax Img*/}

      {/*Start Gallery List*/}
      <BoxGallery className="section-margin container" col={2}>
        <BoxGalleryItem src="/img/project/project3/3.jpg" groupPopup="gallery" caption={'Photography'} />
        <BoxGalleryItem src="/img/project/project3/4.jpg" groupPopup="gallery" caption={'Photography'} />
      </BoxGallery>
      {/*End Gallery List*/}

      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project3/5.jpg'} caption="asdsadsa" />
      {/*End Parallax Img*/}
      ...
      <section className="container section-margin text-center">
        <div className="p-relative">
          ...
          <p className="dsn-up mt-30 ml-auto mr-auto max-w570">
            The LEDs are activated by holding the mAh button on the back, next to the power button; both of
            which help avoid accidental power use and/or drainage whilst on-the-move.
          </p>
        </div>
      </section>
      {/*End Intro Project*/}
