...
function Project6(params) {
  ...
  return (
    <Layout>
        ...
        <DsnGrid customGrid={{ desktop: '40% 60%' }}>
          ...
          <div className="intro-project-right">
            ...
            <p className="intro-project-description">
              The Lengshuikeng region is a low-lying depression which was created when the lava from Mt.
              Qixing and Mt. Qigu formed a barrage. Water then accumulated, turning the area into a lake,
              which eventually leaked out and dried up to expose the lake bottom and form today is landscape.
            </p>
      ...
      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project6/2.jpg'} caption="PHOTOGRAPHY" />
      {/*End Parallax Img*/}
      ...
      <div className="mt-section mb-sm-section has-in-halg-bg p-relative">
        ...
        <div className="dsn-container">
          <BoxGallery col={2}>
            <BoxGalleryItem src="/img/project/project6/3.jpg" groupPopup="gallery" />
            <BoxGalleryItem src="/img/project/project6/4.jpg" groupPopup="gallery" />
          </BoxGallery>
        </div>
      </div>
      {/*End Gallery List*/}
      ...
      <section className="text-center section-padding v-light">
        <div className="container">
          <div className="max-w750 ml-auto mr-auto">
            ...
            <p className="dsn-up">
              What you see in this blog post pales vastly in comparison to the painstaking attention to detail
              showcased in 000. A fine-toothed comb driven by a team of true Porsche enthusiasts has formed
              one of the finest pieces of automotive research, journalism, and photography in existence.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="mb-section has-in-halg-bg p-relative mt-sm-section">
        ...
        <div className="dsn-container">
          <BoxGallery col={2}>
            <BoxGalleryItem src="/img/project/project6/5.jpg" groupPopup="gallery" />
            <BoxGalleryItem src="/img/project/project6/6.jpg" groupPopup="gallery" />
          </BoxGallery>
        </div>
      </div>
      {/*End Gallery List*/}
      ...
      <div className="section-margin p-relative">
        <div className="dsn-container">
          <BoxGallery col={4}>
            <BoxGalleryItem src="/img/project/project6/8.jpg" groupPopup="gallery" />
            <BoxGalleryItem src="/img/project/project6/9.jpg" groupPopup="gallery" />

            <BoxGalleryItem src="/img/project/project6/10.jpg" groupPopup="gallery" />

            <BoxGalleryItem src="/img/project/project6/11.jpg" groupPopup="gallery" />
          </BoxGallery>
        </div>
      </div>
      {/*End Gallery List*/}
