...
function Project5(params) {
  ...
  return (
    <Layout>
        ...
        <DsnGrid customGrid={{ desktop: '40% 60%' }}>
          ...
          <div className="intro-project-right">
            ...
            <p className="intro-project-description">
              Yep, bankruptcy. In 1986, Porsche global sales had plummeted from a high of 53,000, to just
              14,000 in 1993. The numbers are staggering, but this is no secret Porsche will deny. The same
              company that built a legacy of racing thoroughbreds, and works of art that hang in children’s
              rooms everywhere were desperate for a new direction.
            </p>
      ...
      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project5/2.jpg'} caption="PHOTOGRAPHY" />
      {/*End Parallax Img*/}

      {/*Start Gallery List*/}
      <BoxGallery className="section-margin container" col={2}>
        <BoxGalleryItem src="/img/project/project5/3.jpg" groupPopup="gallery" />
        <BoxGalleryItem src="/img/project/project5/4.jpg" groupPopup="gallery" />
      </BoxGallery>
      {/*End Gallery List*/}

      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project5/5.jpg'} caption="PHOTOGRAPHY" />
      {/*End Parallax Img*/}
