...
function Project1() {
  ...
  return (
    <Layout>
      ...
      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project1/2.jpg'} overlay={3} caption="asdsadsa" />
      {/*End Parallax Img*/}

      {/*Start Gallery List*/}
      <BoxGallery className="section-margin container" col={3}>
        <BoxGalleryItem src="/img/project/project1/3.jpg" groupPopup="gallery" />
        <BoxGalleryItem src="/img/project/project1/4.jpg" groupPopup="gallery" />
        <BoxGalleryItem src="/img/project/project1/5.jpg" groupPopup="gallery" />
      </BoxGallery>
      {/*End Gallery List*/}

      {/*Start Parallax Img*/}
      <ParallaxImage alt={''} src={'/img/project/project1/6.jpg'} caption="asdsadsa" />
      {/*End Parallax Img*/}
        ...
        <DsnGrid col={2} colGap={0}>
          <div className="p-relative mb-lg-section">
            <div className="box-im w-100 h-100 p-absolute">
              <ParallaxImage alt={''} src={'/img/project/project1/7.jpg'} height="100%" />
            </div>
          </div>
          <div className="p-relative pt-lg-section">
            <div className="box-info h-100 box-padding background-section ">
              ...
              <p>
                A system that young people around the world with a club culture and techno enthusiasts feel
                identified. We generated a simple logo that is the basis for generating a geometric and liquid
                system.
              </p>
              <p className="mt-15">
                A system that young people around the world with a club culture and techno enthusiasts feel
