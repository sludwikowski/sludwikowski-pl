    ...
    <Layout>
        ...
        <DsnGrid customGrid={{ desktop: '40% 60%' }}>
          ...
          <div className="intro-project-right">
            ...
            <p className="intro-project-description">
              Nestled in a quiet enclave along the recreational waterway of Alexandra Canal, on the fringe of
              the embassy district, Principal Garden reflects a new daring in residential design thinking that
      ...
      <div className="p-relative section-margin v-light">
        ...
        <MoveBox>
          ...
          <p>
            Principal Garden reflects a new daring in residential design thinking that purposefully seeks to
            maximise unbuilt space amid the density of urban Singapore.
          </p>
        </MoveBox>
      </div>
