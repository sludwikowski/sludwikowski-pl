  ...
  return (
    <DsnGrid col={2} colTablet={1} colGap={0} rowGap={0} rowGapTablet={60}>
      ...
      <div className="box-info box-padding p-md-0 ">
        <TitleSection className="mb-30" description={heroData.descTitle} defaultSpace={false}>
          {heroData.title}
        </TitleSection>
        ...
        <div className="d-flex align-items-center mt-30">
          ...
          {heroData.lastLink && (
            <Button {...heroData.lastLink.option} className="line-head" borderRadius>
              {heroData.lastLink.text}
            </Button>
          )}
        </div>
      </div>
