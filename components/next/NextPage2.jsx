...
function NextPage2({ className, ...restProps }) {
  return (
    <section className={dsnCN('next-page p-relative d-flex align-items-center', className)} {...restProps}>
      <BgDot />
      <BgDot rightPosition />
      <div className="container w-100">
        <div className="c-wrapper d-flex justify-content-between">
          <div className="d-flex flex-column">
            ...
            <h2 className="section-title max-w750 mt-15">{NextContent.title}</h2>
          </div>
